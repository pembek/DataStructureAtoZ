...
public class WordBoardTest {
    ...
    @Test
    public void wordBoardTest(){
        char [][] board = new char[][]{{'e', 'a', 'n'},{'t', 't', 'i'},{'a', 'r', 'a'}};
        String [] words = new String[]{"eat", "rain", "in", "rat"};

        assertEquals(4, WordBoard.findWords(board,words).size());
    }

    @Test
    public void wordBoardTestOneWord(){
        char [][] board = new char[][]{{'a', 'b'},{'c', 'd'}};
        String [] words = new String[]{"abcb"};

        assertEquals(0, WordBoard.findWords(board,words).size());
    }

    @Test
    public void wordBoardTest4By4(){
    ...
    @Test
    public void wordBoardTest4By10(){
        char [][] board = new char[][]{{'o', 'a', 'a', 'n'},{'e', 't', 'a', 'e'},
                {'i', 'h', 'k', 'r'},{'i', 'f', 'l', 'v'}};
        String [] words = new String[]{"oath","pea","eat","rain","oathi","oathk","oathf","oate","oathii","oathfi","oathfii"};

        assertEquals(9, WordBoard.findWords(board,words).size());
    }

    @Test
    public void wordBoardTestGiantListOfWords(){
    ...
    @Test
    public void wordBoardUseLettersOnceTest4By10(){
        char [][] board = new char[][]{{'o', 'a', 'a', 'n'},{'e', 't', 'a', 'e'},
                {'i', 'h', 'k', 'r'},{'i', 'f', 'l', 'v'}};
        String [] words = new String[]{"oath","pea","eat","rain","oathi","oathk","oathf","oate","oathii","oathfi","oathfii"};

        assertEquals(9, WordBoard.findWordsUseLettersOnce(board,words).size());
    }
}
